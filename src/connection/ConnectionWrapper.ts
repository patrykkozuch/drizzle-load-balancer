...
export class ConnectionWrapper {
    ...
    constructor(public readonly url: string, public readonly config: ConnectionOptions) {
    ...
    public async isActive(): Promise<void> {
        try {
            console.log(this.state instanceof OfflineState, this.connection?.config.port)
